...
{
    public class CalculateModule : IModule
    {
        /// <summary>
        ...
        public void Initialize()
        {
            ...
            regionManager.RegisterViewWithRegion(RegionNames.MenuRegion, typeof(CalculateNavigatorView));
            ...
            container.RegisterType<Object, CalculateView>("CalculateView");
        }
    }
}